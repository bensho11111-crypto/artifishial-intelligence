...
def parse_args():
    ...
    p.add_argument("--synthetic",  action="store_true", help="Use physics-based synthetic live source")
...
async def main():
    ...
    # ── Layer 1: Data source ──────────────────────────────────────────────
    if args.synthetic:
        print("[main] Using physics-based synthetic live source")
        from ingestion.synthetic_live import SyntheticLiveSource
        source = SyntheticLiveSource(orch.raw_q, hz=args.sim_hz)
    elif args.sl2:
